  ...
  return (
    <div className="">
      {table?.getRowModel().rows?.length > 0 && (
        <div className="flex flex-col items-center justify-between pagination-container p-1 gap-4 md:flex-row bg-transparent">
          {/* <div className="my-3 mx-4 flex flex-col items-center justify-between pagination-container p-1 gap-4 md:flex-row bg-[#F5F5F5] border-b-2 border-x-2 border-[#c7c7c7]"> */}
          ...
          <div className="flex gap-2">
            <button
              ...
              className="disabled:opacity-25 disabled:cursor-not-allowed text-xl rounded-full p-2 bg-violetAltPrimary"
            >
